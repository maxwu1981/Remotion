...
export const Cover: React.FC = () => {
  ...
  // Title is static from frame 0 so the cover lands the instant playback starts
  // (no blank open); the pipeline then builds piece-by-piece beneath it.
  const title = { opacity: 1, transform: "none" };
  ...
  return (
    <Shell durationInFrames={DUR} showChrome={false} accent={MOTIF.commit} seed="cover">
      ...
      <div style={{ position: "absolute", left: 0, right: 0, top: 452, display: "flex", alignItems: "center", justifyContent: "center", gap: 26 }}>
        ...
        <div style={{ marginBottom: 40, display: "flex", alignItems: "center", gap: 6, opacity: ramp(frame, 72, 84) }}>
