/**
 * Ordered registry of the scenes. Root.tsx builds compositions from this, and
 * Master.tsx stitches them together. Each scene owns its own length (derived from
 * the measured VO manifest via buildScene).
 */
